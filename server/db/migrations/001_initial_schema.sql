-- 001 — initial schema (Postgres-flavored; SQLite shim translates types)
...
CREATE TABLE IF NOT EXISTS seller_profiles (
  ...
  revenue_range               VARCHAR(32)  NOT NULL,
  employee_count              INTEGER NOT NULL DEFAULT 0,

  retirement_timeline         VARCHAR(16) NOT NULL,
  ...
  preferred_buyer_type        VARCHAR(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS buyer_profiles (
  ...
  capital_range          VARCHAR(32) NOT NULL,
  sba_eligible           BOOLEAN NOT NULL DEFAULT FALSE,
  credit_score_range     VARCHAR(16) NOT NULL,
  business_experience    VARCHAR(32) NOT NULL,

  preferred_industries   TEXT NOT NULL DEFAULT '[]',
  preferred_size         VARCHAR(32),
...
CREATE TABLE IF NOT EXISTS connections (
  ...
  initiated_by VARCHAR(16) NOT NULL CHECK (initiated_by IN ('buyer','seller')),
...
CREATE INDEX IF NOT EXISTS idx_seller_industry            ON seller_profiles (industry);
CREATE INDEX IF NOT EXISTS idx_buyer_background           ON buyer_profiles (background_type);
